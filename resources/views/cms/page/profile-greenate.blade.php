...
<div class="main">
    ...
    <!-- <div class="order-wrapper d-flex justify-content-center align-items-center">
    ...
    <!-- Ordered-------------------------------------------------------------------- -->
    <div class="order-wrapper d-flex justify-content-center align-items-center ">
        <img src="{{ asset('images/profile-greenate/leaf.png') }}" class="leaf-4">
        <img src="{{ asset('images/profile-greenate/cutting-board.png') }}" class="cutting-board">
        <div class="order-list row d-flex justify-content-around">
            <div class="col-4 item-wrapper d-flex flex-column">
