    ...
    <h5 class="shoppingcart"><button type="submit" class="mx-auto">My Shopping Cart </button><p class="Notif" id="cartNumber">0</p></h5>    
        <div class="main">
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-10 box1">
                    <div class="dineIn active" id="dineIn">
                        ...
                        <label for="dine-in" onclick="change" class="add">Add to cart</label><br><br><br>
                    </div>
                </div>
                <div class="col-md-1 col-1">
                </div>
            ...
            <div class="row monitor">
                ...
                <label for="Tidbit" class="tombol"> Add to Cart</label><br>
                </div>
                <div class="col-md-2 col-2 pilihan mx-auto">
                ...
                <label for="Exhort" class="tombol">Add to Cart</label><br>
                </div>
                <div class="col-md-2 col-2 pilihan mx-auto">
                ...
                <label for="Alter" class="tombol">Add to Cart</label><br>
                </div>
                </form>
                <div class="col-md-1 col-1">
                </div>
                ...
                <div id="carouselExampleControls" class="carousel slide d-lg-none d-block" data-bs-ride="carousel">
                        <div class="carousel-inner row">
                            <div class="item row carousel-item pilihan active box" data-bs-interval="1000000000">
                                ...
                                <label for="Tidbit" class="tombol add">Add to Cart</label><br>
                                </div>
                            </div>
                            <div class="item row carousel-item pilihan  box" data-bs-interval="1000000000">
                                <div class="col-lg-5 col-sm-5 slide-logo">
                                ...
                                <div class="col-lg-5 col-sm-12 info">
                                    ...
                                    <p class="skkm">1 SKKM Pengabdian</p>
                                    <input type="checkbox" id="exhort" class="" hidden name="Exhort" value="Exhort" class="takeAwayOption">
                                    <label for="Exhort" class="tombol add">Add to Cart</label><br>
                                </div>
                            </div>
                            <div class="item row carousel-item pilihan box" data-bs-interval="1000000000">
                                <div class="col-lg-5 col-sm-5 slide-logo">
                                ...
                                <div class="col-lg-5 col-sm-12 info">
                                    ...
                                    <p class="skkm">1 SKKM Pengabdian</p>
                                    <input type="checkbox" id="alter" class="" hidden name="Alter" value="Alter" class="takeAwayOption">
                                    <label for="Alter" class="tombol add">Add to Cart</label><br>
                                </div>
                            </div>
                        </div>
