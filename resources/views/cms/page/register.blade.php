...
<div class="form">
    ...
    <div class="row">
            ...
            <form  action="{{route('register')}}" method="post" class="form-">
                ...
                <input type="text" name="Firstname" id="Firstname" placeholder="Umn" value="{{ old('Firstname') }}" class="form-control" required>
                @if($errors->has('Firstname'))
                <div class=" error">{{ $errors->first('Firstname') }}</div>
                @endif
                <label for="Lastname">Nama Belakang</label>
                <input type="text" name="Lastname" id="Lastname" placeholder="Eco" value="{{ old('Lastname') }}" class="form-control" required>
                @if($errors->has('Lastname'))
                <div class=" error">{{ $errors->first('Lastname') }}</div>
                @endif
                <label for="Student_id">NIM</label>
                <input type="text" name="Student_id" id="Student_id" placeholder="0000001234" value="{{ old('Student_id') }}" class="form-control" required>
                @if($errors->has('Student_id'))
                <div class="error">{{ $errors->first('Student_id') }}</div>
                @endif
                <label for="Email">Email</label>
                <input type="text" name="Email" id="Email" placeholder="eco@umn.ac.id" value="{{ old('Email') }}" class="form-control" required>
                @if($errors->has('Email'))
                <div class="error">{{ $errors->first('Email') }}</div>
                @endif
                <label for="Major">Jurusan</label>
                <select id="Major" name="Major" value="{{ old('Major') }}" class="form-control" required>
                ...
                <select id="Generation" name="Generation" value="{{ old('Generation') }}" class="form-control" required>
                ...
                <input type="text" name="Instagram_account" id="Instagram_account" placeholder="umn_eco" value="{{ old('Instagram_account') }}" class="form-control" required>
                @if($errors->has('Instagram_account'))
                <div class="error">{{ $errors->first('Instagram_account') }}</div>
                @endif
                <label for="Generation">ID Line</label>
                <input type="text" name="Line_id" id="Line_id" placeholder="line_id" value="{{ old('Line_id') }}" class="form-control" required>
                @if($errors->has('Line_id'))
                <div class="error">{{ $errors->first('Line_id') }}</div>
                @endif
                <label for="Phone_number">Nomor Telepon</label>
                <input type="text" name="Phone_number" id="Phone_number" placeholder="08123456789" value="{{ old('Phone_number') }}" class="form-control" required>
                ...
                <input type="password" name="Password_confirmation" id="Password_confirmation" placeholder="Confirm Password" class="form-control" required><br>
...
// nextBtn.on("click",funtion(){console.log("test")})
