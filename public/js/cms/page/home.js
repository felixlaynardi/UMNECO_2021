...
//   scrub: 3
// });
// scene_1.to("#scene-1", { padding: '0px 0px 0px 0px' }, 0);

// // Text Oprec
// let oprec_text = gsap.timeline();
// ScrollTrigger.create({
//   animation: oprec_text,
//   trigger: "#background-1",
//   start: "20% top",
//   end: "+=500",
//   // transformOrigin: "50% 50%",
//   scrub: 3
// });
// oprec_text.to(".oprec-text", { top: '50vh' }, 0);
// oprec_text.to("#scene-1", { backgroundColor: 'black' }, 0);
// oprec_text.to("#lower-lava", { opacity: '0' }, 0);
// oprec_text.to("#upper-lava", { opacity: '0' }, 0);

// // Lower Lava
// let lower_lava = gsap.timeline();
// ScrollTrigger.create({
//   animation: lower_lava,
//   trigger: "#background-1",
//   start: "top top",
//   end: "+=500",
//   // transformOrigin: "50% 50%",
//   scrub: 3
// });
// lower_lava.to("#lower-lava", { top: '0vh' }, 0);


// // Lava Flow
// // let lava_flow = gsap.timeline();
// // ScrollTrigger.create({
// //   animation: lava_flow,
// //   trigger: "#background-1",
// //   start: "10% top",
...
// //   scrub: 3
// // });
// // lava_flow.to("#lava-flow", { top: '60vh' }, 0);
...
//   scrub: true
// });
// scene_2.to(".oprec-text", { opacity: '0' }, 0);
